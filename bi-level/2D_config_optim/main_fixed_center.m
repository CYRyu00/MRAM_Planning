...
opt_var0 = [(2*rand(num_AMs, 1) - 1) * 5 / 180 * pi; thrust_cen; 1];
...
figure('Color', 'w');
trisurf(K, tau_y_arr, f_x_arr, f_z_arr, 'FaceColor', 'cyan', 'FaceAlpha', 0.1, 'EdgeColor', 'b', 'EdgeAlpha', 0.3);
hold on;
...
plot3(offset(1), offset(2), offset(3), 'r*', 'MarkerSize', 10, 'LineWidth', 2);
...
ellipsoid_coords = inv_Q_half * sphere_coords * abs(radius_opt) + center_opt;
