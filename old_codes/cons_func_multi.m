function [c,ceq]=cons_func_multi(X_opt)
    ...
    for k = 1:N-1
        ...
        delta_k = (x_k - x_k1) + dt/6* [ FDynamics_multi(x_k,u_k) ... 
            + 4*FDynamics_multi(x_c,u_c) + FDynamics_multi(x_k1,u_k1)];
