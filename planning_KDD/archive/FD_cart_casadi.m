function [qdd, f_int, tau_int] = FD_cart_casadi(p_1, phi_1, pd_1, w_1, shape_pitch, r_g, U, M, k_obj, b_obj, l1, l2, n_o, n_am)
    import casadi.*

    e_1 = [1; 0; 0]; %e_2 = [0; 1; 0]; e_3 = [0; 0; 1];
    % kinematics
    qd = MX.zeros(n_o + n_am*6, 1);
    ...
    % pfaffin constraints
    A_am = MX.zeros((n_am-1)*6,n_am*6);
    Ad_am = MX.zeros((n_am-1)*6,n_am*6);
